...
OUTPUT_FOLDER_NAME="${output_root}/${boundary_source}_boundary${boundary_width}_${boundary_mode}_${boundary_smooth_mode}_${boundary_time_interp_mode}_${replace_boundary_position}"
