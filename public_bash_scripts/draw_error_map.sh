python plot_residual.py --var_name t2m --output_dir residual_plots_baseline \
...
for bw in 4 8; do
    for interp in "nearest" "exact"; do
        for smooth in "mean" "gaussian"; do
            python plot_residual.py --var_name t2m --output_dir residual_plots_${bw}_${smooth}_${interp} \
